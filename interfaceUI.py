...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dataset_table.horizontalHeader().setDefaultSectionSize(190)
        ...
        self.result_table.horizontalHeader().setDefaultSectionSize(190)
        ...
        self.filteringSame_radio.setGeometry(QtCore.QRect(30, 50, 191, 20))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.filteringSame_radio.setFont(font)
        ...
        self.filteringKey_radio.setGeometry(QtCore.QRect(30, 80, 211, 20))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.filteringKey_radio.setFont(font)
        self.filteringKey_radio.setObjectName("filteringKey_radio")
        self.filtering_textEdit = QtWidgets.QTextEdit(self.filtering_group)
        self.filtering_textEdit.setGeometry(QtCore.QRect(240, 70, 141, 31))
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.similarity_combo.setFont(font)
        ...
        self.similarity_textEdit.setGeometry(QtCore.QRect(180, 10, 111, 31))
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.Product_checkbox.setFont(font)
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.Issue_checkbox.setFont(font)
        self.Issue_checkbox.setObjectName("Issue_checkbox")
        self.Company_checkbox = QtWidgets.QCheckBox(self.columns_group)
        self.Company_checkbox.setGeometry(QtCore.QRect(40, 90, 111, 20))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.Company_checkbox.setFont(font)
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.State_checkbox.setFont(font)
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.ZIP_checkbox.setFont(font)
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.All_checkbox.setFont(font)
        ...
        self.thread_table.horizontalHeader().setDefaultSectionSize(170)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.filteringSame_radio.setText(_translate("MainWindow", "Aynı olanlar (Senaryo 2)"))
        self.filteringKey_radio.setText(_translate("MainWindow", "Complaint Id (Senaryo 3)"))
